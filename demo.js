...
// var totalPRice = books.reduce((totalPrice, book) => {
//     return totalPrice + book.price;
// }, 0)

// console.log(totalPRice)

// var results = books.reduce((tally, book) => {
//     if(!tally[Math.floor(book.price)])
//         tally[Math.floor(book.price)] = [];
//     tally[Math.floor(book.price)].push(book.title)
//     return tally;
// },{})
